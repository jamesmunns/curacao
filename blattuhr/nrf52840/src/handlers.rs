use embassy_time::{Delay, Instant, Duration, Timer};
use epd_waveshare::prelude::WaveshareDisplay;
use postcard_rpc::{header::VarHeader, server::Sender};
use template_icd::{
    decode_to, DecodeError, DisplayCommand, DisplayResult, DrawResult, LedState, SleepEndpoint, SleepMillis, SleptMillis, TooSoon
};

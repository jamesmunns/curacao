...
use embassy_nrf::{
    bind_interrupts,
    buffered_uarte::{self, BufferedUarte, BufferedUarteTx},
...
use postcard_rpc::server::impls::embedded_io_async_v0_6::{EioWireRx, EioWireTx, EioWireTxInner};
...
async fn main(spawner: Spawner) {
    ...
    static TX_STO: StaticCell<
        Mutex<ThreadModeRawMutex, EioWireTxInner<BufferedUarteTx<'static, UARTE0>>>,
    > = StaticCell::new();
    ...
    let server: app::AppServer = Server::new(tx_impl, rx_impl, RX_BUF3.take(), dispatcher, vkk);
